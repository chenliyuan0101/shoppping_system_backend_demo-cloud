 ...
 * 开启：application-dev.yaml logging.level.com.mall.review=debug（默认已开）。
 *
 * <p>切点根包从 {@code com.mall.demo} 换成 {@code com.mall.review}——
...
public class MethodLogAspect {
    ...
    @Around("execution(* com.mall.review..controller..*(..))"
            + " || execution(* com.mall.review..service..*(..))"
            + " || execution(* com.mall.review..task..*(..))")
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        // 先判级别再拼参数：briefArgs 会把实参整体 JSON 序列化（大对象如评价内容+图片数组很贵），
