 ...
 *
 * <p>P4-2 从单体共享内核（{@code com.mall.demo.common.MqMessages}）复制的契约副本，
 * 与 user-center 的同名类逐字同构。<b>必须与单体逐字同构</b>：单体的
 * {@code OrderEventPublisher#publishRawAfterCommit} 用 {@link #json} 生产消息，
...
public final class MqMessages {
     ...
     * @param messageId 消息 id（便于在管理台定位，通常是业务单号）
    ...
    /** 解析 JSON 正文（字段名与单体的 {@code OrderFinishedMessage} 记录逐字对应） */
