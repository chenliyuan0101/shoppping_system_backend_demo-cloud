package com.mall.usercenter.support.constant;
 ...
 * {@code pms_comment.status}(0待审核/1展示/2隐藏，见 {@link com.mall.usercenter.pms.support.CommentStatus})、
 * {@code sms_coupon.status}(0启用/1停用，**极性相反**，见 {@link com.mall.usercenter.sms.support.CouponStatus})。
 */
