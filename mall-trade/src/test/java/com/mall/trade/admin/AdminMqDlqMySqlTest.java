...
import com.mall.trade.oms.mq.OrderTimeoutMessage;
...
class AdminMqDlqMySqlTest extends MySqlTestBase {
    ...
    void requeueProductSyncDlq() throws Exception {
        ...
        var payload = new com.mall.trade.pms.mq.ProductSyncMessage(java.util.List.of(1001L), null, System.currentTimeMillis());
