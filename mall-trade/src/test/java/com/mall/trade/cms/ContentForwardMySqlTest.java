...
class ContentForwardMySqlTest extends MySqlTestBase {
    ...
    void createBannerForwardsBody() throws Exception {
        ...
        ArgumentCaptor<com.mall.trade.common.dto.BannerSaveRequest> captor =
                ArgumentCaptor.forClass(com.mall.trade.common.dto.BannerSaveRequest.class);
