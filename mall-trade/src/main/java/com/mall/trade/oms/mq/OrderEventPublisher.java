...
import com.mall.trade.oms.outbox.TradeOutboxRelay;
import com.mall.trade.oms.outbox.TradeOutboxService;
 ...
 * {@link com.mall.trade.oms.outbox.TradeOutboxRelay} 定时重投（至少一次语义）。
 *
 * <p>仍然保留的两条既有约定：
 * <ul>
