 ...
 * 开启：application-dev.yaml logging.level.com.mall.trade=debug（默认已开）。
 */
@Aspect
@Component
@Slf4j
public class MethodLogAspect {
    ...
    @Around("execution(* com.mall.trade..controller..*(..))"
            + " || execution(* com.mall.trade..service..*(..))"
            + " || execution(* com.mall.trade..task..*(..))")
