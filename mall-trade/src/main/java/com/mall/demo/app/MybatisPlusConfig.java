 ...
 *
 * <p>P2：{@code com.mall.demo.cms.mapper} 已随内容域搬去 {@code mall-content}
 * （连带 {@code cms_banner}/{@code cms_notice} 两张表一起进了 {@code mall_content} schema），
 * 因此这里少一个包。后续每抽走一个域都会少一个——这正是 D.5 里"等 P2 按服务自带组装根处理"的意思。
 *
 * <p>P3-4：{@code com.mall.demo.auth.mapper} 与 {@code com.mall.demo.ums.mapper} 里的
 ...
 *
 * <p>P3-5：最后那个 {@code com.mall.demo.ums.mapper}（{@code NotificationMapper}）也删了——
 ...
 *
 * <p><b>P5 步骤 C</b>：{@code com.mall.demo.sms.mapper} 也移出扫描包了——券的读写整体搬到
 ...
 *
 * <p><b>P6-6（决策 D6）：{@code com.mall.demo.pms.mapper} 按同一条理由移出扫描包。</b>
 ...
 */
@Configuration
@MapperScan({"com.mall.demo.admin.mapper",
        "com.mall.demo.oms.mapper"})
