package com.mall.demo.common.contract;
 ...
 * {@link com.mall.demo.app.UserCenterRemoteConfig} 提供（调 {@code /internal/v1/user/member/**}）。
 *
 * <p>为什么从 {@code com.mall.demo.auth.service} 挪到 {@code common.contract}：
 * 会员域的实现（mapper/entity/Service）已经整体搬走，接口留在 {@code auth} 包会留下一个
 * "没有属主域的域服务接口"——而它现在的作用恰恰是<b>跨服务契约</b>（HTTP 形状被 {@code UserCenterClient}
 * 逐字实现），与 {@link com.mall.demo.common.dto.MemberBriefVO} 等契约快照同层才自洽。
