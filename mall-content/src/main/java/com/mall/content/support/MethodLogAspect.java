...
import com.mall.content.support.JsonKit;
 ...
 * 开启：application-dev.yaml logging.level.com.mall.demo=debug（默认已开）。
 */
@Aspect
@Component
@Slf4j
public class MethodLogAspect {
    ...
    @Around("execution(* com.mall.content..controller..*(..))"
            + " || execution(* com.mall.content..service..*(..))"
            + " || execution(* com.mall.content..task..*(..))")
